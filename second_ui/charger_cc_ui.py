...
class CHARGER_CC_UI:
    ...
    def create_charger_cc_module(self):
        ttk.Label(self.content_frame, text="Charger cc current test", font=("Arial", 20)).pack(pady=20)
        ttk.Label(self.content_frame, text="This is the Charger cc current test module.").pack(pady=10)
    ...
    def check_iic_weight(self):
        ...
        reg_addr = 0x01
        charger_addr = 0x17
        self_pmu_reg_8b = deviceI2C.read_register_value_8bit(self_charger, reg_addr)
        self_pmu_reg_10b = deviceI2C.read_register_value_10bit(self_charger, reg_addr)
...
Please choose the write weight of your test""")
    ...
    def run_test(self):
        ...
        # read_data = deviceI2C.read_register_value(0x27, 0x6)
        # deviceI2C.write_register_value(0x27, 0x6, 0xe264)
        # read_data = deviceI2C.read_register_value(0x27, 0x6)
    ...
    def run_output_voltage_test(self):
        ...
        self.controller.set_channel_range(vol_channel)
